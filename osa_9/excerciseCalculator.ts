...
const calculateExcercises = (
  ...
  const ratingPercent: number = averageHours / targetTrainingHoursPerDay;
...
export const calcExercises = (
  ...
  const { dailyHours, target } = parseInput(
    trainingHoursPerDay,
    targetHoursPerDay
  );
